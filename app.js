...
// ---- Decks ----
var DECKS = {
  noblet: {name:'Jean Noblet DEMO (78)', cards:(function(){var a=[];for(var i=0;i<78;i++)a.push({id:i,file:'assets/decks/noblet/'+('0'+i).slice(-2)+'.jpg'});return a;})()},
  rosenwald: {name:'Rosenwald', cards:(function(){var a=[];for(var i=0;i<78;i++)a.push({id:i,file:'assets/decks/rosenwald/'+('0'+i).slice(-2)+'.jpg'});return a;})()},
  visconti_sforza: {name:'Visconti‑Sforza', cards:(function(){var a=[];for(var i=0;i<78;i++)a.push({id:i,file:'assets/decks/visconti_sforza/'+('0'+i).slice(-2)+'.jpg'});return a;})()},
  budapest: {name:'Budapest', cards:(function(){var a=[];for(var i=0;i<78;i++)a.push({id:i,file:'assets/decks/budapest/'+('0'+i).slice(-2)+'.jpg'});return a;})()}
};

// ---- Question sets (70 + 50 + 52) ----
var DEFAULT_QSETS = {"Practica 70":[
...
"¿Cuál es mi propósito de vida en este momento?","¿Qué necesito saber sobre mi situación actual?","¿Cómo puedo superar los obstáculos que estoy enfrentando?","¿Qué debo aprender de mis desafíos actuales?","¿Qué talentos debo desarrollar para alcanzar mis metas?","¿Qué me está impidiendo avanzar?","¿Qué acciones debo tomar para encontrar paz interior?","¿Qué debo saber para tomar mejores decisiones?","¿Qué me impide avanzar en mi vida?","¿Cuál es mi misión en esta vida?",
"¿Qué puedo hacer para atraer una relación amorosa saludable?","¿Cómo puedo mejorar mi relación actual?","¿Qué debo aprender de mis experiencias amorosas pasadas?","¿Cómo puedo sanar de una ruptura amorosa?","¿Qué aspectos de mi comportamiento afectan mis relaciones amorosas?","¿Cuál es la base real de nuestro problema?","¿Cómo se siente mi pareja en esta situación?","¿Hacia dónde se dirige nuestra relación?","¿Qué puedo hacer yo para mejorar esta situación?","¿Cómo vamos a resolver esta situación?",
"¿Cómo puedo avanzar en mi carrera profesional?","¿Qué puedo hacer para encontrar un trabajo que me apasione?","¿Qué habilidades necesito desarrollar para tener éxito?","¿Qué debo considerar al pensar en un cambio de carrera?","¿Cómo puedo manejar mejor el estrés laboral?","¿Qué me está impidiendo alcanzar mis objetivos profesionales?","¿Cómo puedo encontrar un mejor equilibrio entre vida laboral y personal?","¿Qué oportunidades de crecimiento están disponibles para mí?","¿Qué energías me rodean en el trabajo?","¿Qué está bloqueando mi éxito profesional?",
"¿Cómo puedo mejorar mi situación financiera?","¿Qué pasos debo seguir para alcanzar estabilidad económica?","¿Cómo puedo aumentar mis ingresos?","¿Qué hábitos financieros debo cambiar?","¿Qué me está impidiendo alcanzar metas financieras?","¿Qué debo saber antes de una inversión importante?","¿Qué me está impidiendo alcanzar estabilidad material?","¿Cómo puedo liberarme de deudas?","¿Cómo puedo atraer abundancia?","¿Qué oportunidad financiera puedo abrir?",
"¿Qué puedo hacer para mejorar mi salud física?","¿Cómo puedo manejar mejor el estrés y la ansiedad?","¿Qué hábitos debo adoptar para una vida más saludable?","¿Qué debo saber sobre mi bienestar emocional?","¿Cómo puedo equilibrar cuerpo y mente?","¿Qué está agotando mi energía?","¿Cómo puedo mejorar mi salud mental?","¿Qué me impide alcanzar un estado de bienestar óptimo?","¿Cómo puedo fortalecer mi sistema inmunológico?","¿Qué hábitos de bienestar necesito reevaluar?"
],"Completo 52":[
"¿Cuál es mi propósito de vida en este momento?","¿Qué necesito saber sobre mi situación actual?","¿Cómo puedo superar los obstáculos que estoy enfrentando?","¿Qué debo aprender de mis desafíos actuales?","¿Qué talentos debo desarrollar para alcanzar mis metas?","¿Qué me está impidiendo avanzar?","¿Qué acciones debo tomar para encontrar paz interior?","¿Qué debo saber para tomar mejores decisiones?","¿Qué me impide avanzar en mi vida?","¿Cuál es mi misión en esta vida?",
"¿Qué puedo hacer para atraer una relación amorosa saludable?","¿Cómo puedo mejorar mi relación actual?","¿Qué debo aprender de mis experiencias amorosas pasadas?","¿Cómo puedo sanar de una ruptura amorosa?","¿Qué aspectos de mi comportamiento afectan mis relaciones amorosas?","¿Cuál es la base real de nuestro problema?","¿Cómo se siente mi pareja en esta situación?","¿Hacia dónde se dirige nuestra relación?","¿Qué puedo hacer yo para mejorar esta situación?","¿Cómo vamos a resolver esta situación?",
"¿Cómo puedo avanzar en mi carrera profesional?","¿Qué puedo hacer para encontrar un trabajo que me apasione?","¿Qué habilidades necesito desarrollar para tener éxito?","¿Qué debo considerar al pensar en un cambio de carrera?","¿Cómo puedo manejar mejor el estrés laboral?","¿Qué me está impidiendo alcanzar mis objetivos profesionales?","¿Cómo puedo encontrar un mejor equilibrio entre vida laboral y personal?","¿Qué oportunidades de crecimiento están disponibles para mí?","¿Qué energías me rodean en el trabajo?","¿Qué está bloqueando mi éxito profesional?",
"¿Cómo puedo mejorar mi situación financiera?","¿Qué pasos debo seguir para alcanzar estabilidad económica?","¿Cómo puedo aumentar mis ingresos?","¿Qué hábitos financieros debo cambiar?","¿Qué me está impidiendo alcanzar metas financieras?","¿Qué debo saber antes de una inversión importante?","¿Qué me está impidiendo alcanzar estabilidad material?","¿Cómo puedo liberarme de deudas?","¿Cómo puedo atraer abundancia?","¿Qué oportunidad financiera puedo abrir?",
"¿Qué puedo hacer para mejorar mi salud física?","¿Cómo puedo manejar mejor el estrés y la ansiedad?","¿Qué hábitos debo adoptar para una vida más saludable?","¿Qué debo saber sobre mi bienestar emocional?","¿Cómo puedo equilibrar cuerpo y mente?","¿Qué está agotando mi energía?","¿Cómo puedo mejorar mi salud mental?","¿Qué me impide alcanzar un estado de bienestar óptimo?","¿Cómo puedo fortalecer mi sistema inmunológico?","¿Qué hábitos de bienestar necesito reevaluar?",
"¿Qué mensaje importante necesito recibir del tarot hoy?","¿Qué aspecto de mi vida requiere más atención consciente ahora mismo?"
]};
...
function availableIds(deckKey,scope){var ids=DECKS[deckKey].cards.map(function(c){return c.id;}); if(scope==='majors'){ids=ids.slice(0,22);} return ids;}
...
function reveal(){
  ...
  questionEl.textContent=q; questionEl.classList.remove('hidden');
}
...
function exportCSV(){
  ...
  for(var i=0;i<log.length;i++){
    var e=log[i];
    rows.push([e.ts,e.deck,(e.spread==='grid3'?'3x3':'linea5'),(e.scope==='majors'?'mayores':'completo'),e.cards.join(' '),e.question,(e.notes||'').replace(/\n/g,' ')]);
  }
  var csv=rows.map(function(r){return r.map(function(x){var s=String(x).replace(/\"/g,'\"\"'); return '\"'+s+'\"';}).join(',');}).join('\\n');
  var blob=new Blob([csv],{type:'text/csv;charset=utf-8;'});
  var url=URL.createObjectURL(blob);
  var a=document.createElement('a'); a.href=url; a.download='tarot_historial.csv'; document.body.appendChild(a); a.click(); setTimeout(function(){URL.revokeObjectURL(url);a.remove();},500);
}
...
function saveEditor(){var arr=document.getElementById('edText').value.split(/\\n/).map(function(s){return s.trim();}).filter(function(s){return s.length>0;}); var name=qsetSelect.value; saveQset(name, arr); QSETS = loadQsets(); renderQsets(); qsetSelect.value=name; closeEditor();}
